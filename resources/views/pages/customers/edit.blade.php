    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                {{-- Menggunakan rute customers.index --}}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        {{-- PERBAIKAN: Mengganti action ke route yang benar dan menggunakan @method('PUT') --}}
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('address') is-invalid @enderror"
                                                name="address"
                                                data-height="150">{{ old('address', $customer->address) }}</textarea>
                                            @error('address')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-12 text-right"> 
                                        <button type="submit" class="btn btn-icon icon-left btn-primary"> <i class="fas fa-save"></i> Perbarui</button>
                                    </div>
                                </div>
                            </div>
                        </form>
