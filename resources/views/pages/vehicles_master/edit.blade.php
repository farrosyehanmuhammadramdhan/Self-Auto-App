...
@section('title', 'Edit Kendaraan Master')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Edit Master Kendaraan</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Edit Master Kendaraan</h2>
            <p class="section-lead">
                Isi Form Ini Untuk Mengubah Data Master Kendaraan.
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
